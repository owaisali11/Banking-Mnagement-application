...
<head>
    ...
    <script defer src="homepageScript1.js"></script>
        ...
        <nav class="nav">
            ...
            <div class="centre">
                <ul class="nav__links">
                    ...
                    <li class="nav__item">
                        <a class="nav__link" href="#section--2">Facilities</a>
                    </li>
                    <li class="nav__item">
            ...
            <div class="end">
                <ul class="nav__links">
                    <li class="nav__item">
                        <a class="nav__link nav__link--btn btn--show-login-modal" href="./loginpage.php">Login</a>
                    </li>
                    <li class="nav__item">
                        <a class="nav__link nav__link--btn btn--show-account-modal" href="./adminlogin.php">Admin
                        </a>
                    </li>
                    <li class="nav__item">
                        <a class="nav__link nav__link--btn btn--show-account-modal" href="./openAcc.php">Open Account</a>
                    </li>
