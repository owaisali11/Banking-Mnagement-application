...
if(isset($_POST['submit_deleteEmployee'])){
  ...
  if($num2!=""){
  $delete_employee = mysqli_query($conn,"DELETE FROM employees where username='$username'; ");
...
<head>
  ...
  <link rel="stylesheet" href="adminpageeee.css" />
  <script defer src="./Styles/adminpageeeee.js"></script>
